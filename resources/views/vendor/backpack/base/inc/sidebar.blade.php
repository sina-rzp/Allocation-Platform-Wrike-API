    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="{{ url('admin/team') }}"><i class="fa fa-sitemap" aria-hidden="true"></i> <span>Teams</span></a></li>

          <li><a href="{{ url('admin/task') }}"><i class="fa fa-tasks" aria-hidden="true"></i> <span>Tasks</span></a></li>
